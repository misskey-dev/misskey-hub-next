...
字首: `Ui:`\
可在[小工具](/docs/for-users/features/widgets/) (AiScript App)、[Misskey Play](./plugin/create-play/)、Scratchpad 中使用。 如需更多資訊，請參閱[AiScript Misskey 擴展 API 參考文件](./plugin/plugin-api-reference/)中標記為 `Ui:`的部分。
...
`message`: `any`\
回傳值: `null`\
可在[小工具](/docs/for-users/features/widgets/)（AiScript控制台）、Scratchpad 使用。  
\
輸出字串到瀏覽器網頁開發者工具的主控台。  
\
跟`<:`語法的運作方式類似。

...
一種可在 Misskey 中使用並在 JavaScript 上運行的程式語言。詳情參考[這裡](../features/note/#renote)詳情參考[這裡](https://github.com/aiscript-dev/aiscript/blob/master/README.md)

## API

Misskey 伺服器提供的界面，用於從您的程式中處理 Misskey 的相關功能。詳情參考[這裡](https://xn--931a.moe/)詳情參考[這裡](../../for-developers/api)
...
引用已有貼文或將該貼文作為新貼文共享的行為，以及由此創建的貼文。關於時間軸的詳情可參考[這裡](../features/timeline)]\(../features/note/#renote)
...
Misskey的看板娘（官方代表人物）。詳情參考[這裡](../features/note/#cw)]\(https\://xn--931a.moe/)
...
非自訂表情符號的普通表情符號被稱為「Unicode表情符號」。非自訂表情符號的普通表情符號被稱為「Unicode表情符號」。關於時間軸的詳情可參考[這裡](../features/timeline)詳情參考[這裡](../features/custom-emoji)
...
使用者在 Misskey 伺服器上發布的文章。它可以包括各種 Misskey 自己的內容，如圖片、音樂和其他文件、投票等。詳情參考[這裡](../features/mfm)]\(../features/note)

...
Before changing any settings, first check that your internet service provider is not experiencing any outages or scheduled maintenance, that your connection speed is sufficient, that your network settings are correct, and whether the server is experiencing any outages or maintenance. Then try or check the following:
...
## Indicators such as Notifications and Antennas keep blinking

Blinking indicates that you have unread content.If the indicator keeps blinking, scroll back to find content you haven’t read yet. If you believe you’ve read everything but it still keeps blinking (likely a bug), you can force-mark everything as read in Settings.

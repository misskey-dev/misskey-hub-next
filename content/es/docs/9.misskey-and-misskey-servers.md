...
Se trata estrictamente de un «software para crear servicios web» y no del «servicio web en sí» donde se realizan el registro y el inicio de sesión.
...
Las cuentas de spam pueden afirmar ser «Misskey Operations» o «Misskey Support».

Como se ha mencionado anteriormente, tales organizaciones o puntos de contacto no existen.Por favor tenlo en cuenta.

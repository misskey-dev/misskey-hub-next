...
The Misskey Project often receives inquiries from people who confuse a Misskey server for Misskey (the Misskey Project does not operate any Misskey servers.Additionally, this website is the official website for “Misskey” and is not the website for “Misskey servers.”)
...
Misskey is often described as a “social networking service,” but this is incorrect.

Misskey is a “software for creating web services” and is not the “web service itself” that handles you or others' account management.

:::tip

This means there is no such thing as "the Misskey administrator."

If you have experience registering or logging in, that would be with a Misskey server, not Misskey itself.

:::

:::warning

Recently, spam accounts have been impersonating “Misskey administrator” or “Misskey support.”

As mentioned earlier, such organizations or contact points do not exist in the first place.
...
As of 2025, there are over 1,000 known Misskey servers.
...
n.b. As mentioned before, both Misskey and individual servers are commonly referred to as Misskey. When someone mentions Misskey, they may actually be referring to an individual server.Please keep this in mind.
...
![Image](/img/docs/misskey-and-misskey-servers.ja-jp.png)

...
By specifying any of the following parameters, the note can be posted as a reply to the specified note.
...
You can specify one of the following to make the note a Renote (quote) of a specific note.

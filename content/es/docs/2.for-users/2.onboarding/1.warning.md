...
- Los nombres de usuario no se pueden cambiar posteriormente.Una vez eliminada una cuenta, no se puede recuperar el mismo nombre de usuario.
...
Por favor, ten esto en cuenta y disfruta utilizando Misskey.

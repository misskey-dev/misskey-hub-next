...
As a return for your generous and valuable support of the Misskey Project, you will receive a physical Misskey ID Plate!

**Misskey ID Plate is highly durable metal card (plate) with a serial number and owner tied to it.**

Precision machining on heavy metal has been used to create a plate with a high status.
...
If you prefer, we can send you a plate with “syuilo” autograph on the back.(Free)
...
Note: The application form can only be submitted once. For subsequent applications, please use the “Contact Form” to submit information equivalent to that in the application form.
...
Qualified applicants who wish to receive this plate must read the content of this page (including [Note](#note)) and apply on the form.

Please note that due to shipping reasons, **this card can only be obtained by residents of Japan.**

:::warning

**This plate is a benefit for those who support the Misskey Project (syuilo).**
...
[Misskey ID Plate Application Form](https://forms.gle/3EcRw21nUcGqGVk68)
...
- You may be required to verify your identity when you receive your plate.

The plate will be carefully packaged and shipped after inspection.If there is any damage upon arrival, please contact Japan Post.

:::warning

The plate will be delivered to the address provided.
Please note that plate cannot be delivered to addresses other than the applicant's own.
...
- There may be slight individual differences in dimensions and processing.Please enjoy this as a unique characteristic of your item.

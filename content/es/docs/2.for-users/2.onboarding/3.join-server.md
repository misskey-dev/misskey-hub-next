...
- Código de invitación (solo si la inscripción es solo por invitación.Si no dispones de uno, no podrás registrarte.)
- Nombre de Usuario (**No podrás cambiarlo más adelante. Una vez que renuncies a tu registro, no podrás obtener el mismo nombre de usuario.**）
...
Una vez que hayas rellenado la información requerida, recibirás un correo electrónico de confirmación para los servidores que obliguen a dar una dirección de correo electrónico, así que haz clic en el enlace del correo electrónico lo antes posible.

![Email de Confirmación](/img/docs/for-users/onboarding/join-server/3.ja.png)

¡Con esto, has terminado el registro en un servidor de Misskey!

¡Ahora eres un [Misskero (En inglés Misskist)](../resources/glossary/#misskero-en-inglés-misskist)!Disfruta de una experiencia de comunicación divertida y nueva.
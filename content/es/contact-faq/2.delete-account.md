...
**Si has cometido un error en tus datos de contacto, por favor, comprueba los datos de contacto correctos.なお、アカウントの削除方法はサーバーによって異なることがありますので、削除できない場合は、アカウントを削除しようとしているサーバーの管理者に**直接\*\*お問い合わせください。

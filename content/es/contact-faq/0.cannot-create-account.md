...
**Si has cometido un error en tus datos de contacto, por favor, comprueba los datos de contacto correctos.なお、入力事項や登録方法はサーバーによって異なることがありますので、登録できない場合は、アカウントを作成しようとしているサーバーの管理者に**直接\*\*お問い合わせください。

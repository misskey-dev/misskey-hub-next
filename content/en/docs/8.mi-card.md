...
Note: The design on the reverse side is omitted.
...
例えば、5万円以上で2枚、8万円以上で3枚、というような計算になります。
...
Applications will be confirmed after you submit the form.Submitting the form does not guarantee that you will receive the card.
...
- Card images, videos and 3D models are for illustrative purposes only.
